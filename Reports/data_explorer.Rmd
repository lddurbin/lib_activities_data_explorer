...
cols <- read_csv(here::here("data/expected_column_headers.csv")) %>%
  as_tibble(.rows = NULL) %>%
  add_row()
...
bscols(
  ...
  list(
    ...
    filter_select("what_was_the_format_of_the_session", "Session Format", data_explorer, ~ what_was_the_format_of_the_session),
