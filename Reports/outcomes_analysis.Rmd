...
`r if(params$outcome == "Literacy") {"At the broadest level, literacy programmes are designed for particular age groups: adults, youths, and children. The table below shows how many sessions designed to *exclusively* benefit adults were said to have delivered against each outcome, the number of adults (aged 18+) who participated in these sessions, and the total duration of these sessions in hours. You can click on the column headers to re-sort the table accordingly."}`
...
if(params$outcome == "Literacy") {
  ...
  DT::datatable(
    adult_literacy_data,
    colnames = c('Outcome', 'Sessions', 'Participants (18+)', 'Total Duration'),
    caption = caption,
    options = list(dom = 't'),
    rownames = FALSE
  )
...
`r if(params$outcome == "Literacy") {"The table below shows how many sessions designed to *exclusively* benefit youths were said to have delivered against each outcome, the number of adults (aged 18+) and children (aged under 18) who participated in these sessions, and the total duration of these sessions in hours. You can click on the column headers to re-sort the table accordingly."}`
...
`r if(params$outcome == "Literacy") {"The table below shows how many sessions designed to benefit children (pre-school and primary) were said to have delivered against each outcome, the number of adults (aged 18+) and children (aged under 18) who participated in these sessions, and the total duration of these sessions in hours. You can click on the column headers to re-sort the table accordingly."}`
