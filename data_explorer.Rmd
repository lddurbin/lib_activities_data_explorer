...
delivery_agents <- left_join(concat_libs, concat_units) %>% 
...
data_explorer_data <- plyr::join_all(list(base_table, delivery_agents, age_groups, target_groups, realm_languages), by="id", type="left") %>%
