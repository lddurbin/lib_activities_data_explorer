...
This data was last refreshed on **`r stamp("Sunday, May 1 2000 at 1.30pm")(lastModified(files) %>% with_tz("NZ"))`**. The data will be refreshed on the first working day of each month.
...
expected_teams <- read_csv("data/expected_teams.csv", col_types = "cc")
